...
async fn admission(req: Json<DATAResult>) -> HttpResponse {
    ...
    requete2= requete2 + &req.dns.domain.clone() + &"\", ".to_string() + &req.dns.note.to_string() + &",\" ".to_string() + &req.dns.bimi.version.clone() + &"\", \"".to_string() + &req.dns.bimi.url_expediteur.clone() + &"\", \"".to_string() + &req.dns.bimi.url_politique.clone() + &"\", \"".to_string() + &req.dns.bimi.url_reputation.clone()  + &"\", \"".to_string() +  &req.dns.bimi.hash.clone()  + &"\", \"".to_string() + &req.dns.bimi.s.clone() + &"\", \"".to_string() + &req.dns.certificate.signature_algorithm_server.clone()  + &"\", \"".to_string() + &req.dns.certificate.IssuerDetails.city.clone()  + &"\", \"".to_string() + &req.dns.certificate.IssuerDetails.state.clone() + &"\", \"".to_string() + &req.dns.certificate.IssuerDetails.locality.clone() + &"\", \"".to_string() + &req.dns.certificate.IssuerDetails.organization.clone() + &"\", \"".to_string() + &req.dns.certificate.IssuerDetails.common_name.clone() + &"\", \"".to_string() + &req.dns.certificate.ValidityDetails.not_before.clone() + &"\", \"".to_string() + &req.dns.certificate.ValidityDetails.not_after.clone() + &"\", \"".to_string() + &req.dns.certificate.ValidityDetails.is_valid.clone() + &"\", \"".to_string() + &req.dns.certificate.SubjectDetails.city.clone() + &"\", \"".to_string() + &req.dns.certificate.SubjectDetails.state.clone() + &"\", \"".to_string() + &req.dns.certificate.SubjectDetails.locality.clone() + &"\", \"".to_string() + &req.dns.certificate.SubjectDetails.organization.clone() + &"\", \"".to_string() + &req.dns.certificate.SubjectDetails.common_name.clone() + &"\", \"".to_string();
    
    for i in &req.dns.certificate.extensions_server.subject_alternative_names{
    	requete2=requete2 + &i;
    }
	
     requete2 = requete2 + &"\", \"".to_string() + &req.dns.certificate.signature_algorithm_intermediate.clone() + &"\", \"".to_string() + &req.dns.certificate.issuer_intermediate.city.clone() + &"\", \"".to_string() + &req.dns.certificate.issuer_intermediate.state.clone() + &"\", \"".to_string() + &req.dns.certificate.issuer_intermediate.locality.clone() + &"\", \"".to_string() + &req.dns.certificate.issuer_intermediate.organization.clone() + &"\", \"".to_string() + &req.dns.certificate.issuer_intermediate.common_name.clone() + &"\", \"".to_string() + &req.dns.certificate.validity_intermediate.not_before.clone() + &"\", \"".to_string() + &req.dns.certificate.validity_intermediate.not_after.clone() + &"\", \"".to_string() + &req.dns.certificate.validity_intermediate.is_valid.clone() + &"\", \"".to_string() + &req.dns.certificate.subject_intermediate.city.clone() + &"\", \"".to_string() + &req.dns.certificate.subject_intermediate.state.clone() + &"\", \"".to_string() + &req.dns.certificate.subject_intermediate.locality.clone() + &"\", \"".to_string() + &req.dns.certificate.subject_intermediate.organization.clone() + &"\", \"".to_string() + &req.dns.certificate.subject_intermediate.common_name.clone() + &"\", \"".to_string() + &req.dns.certificate.extensions_intermediate.subject_alternative_names.clone() + &"\", \"".to_string() + &req.dns.dane.forme_certificat.clone() + &"\", \"".to_string() + &req.dns.dane.signature_certificat.clone() + &"\", \"".to_string() + &req.dns.dane.signature_cle_publique.clone() + &"\", \"".to_string() + &req.dns.dane.presence_hash.clone() + &"\", \"".to_string() + &req.dns.dane.hash.clone() + &"\", \"".to_string() + &req.dns.dmarc.v.clone() + &"\", \"".to_string() + &req.dns.dmarc.p.clone()  + &"\", \"".to_string() + &req.dns.dmarc.sp.clone() + &"\", \"".to_string() + &req.dns.dmarc.pct.clone() + &"\", \"".to_string() + &req.dns.dmarc.ruf.clone()  + &"\", \"".to_string() + &req.dns.dmarc.rua.clone() + &"\", \"".to_string() + &req.dns.dmarc.ri.clone() + &"\", \"".to_string() + &req.dns.dmarc.rf.clone() + &"\", \"".to_string() + &req.dns.dmarc.aspf.clone() + &"\", \"".to_string() + &req.dns.dmarc.adkim.clone() + &"\", \"".to_string() + &req.dns.dmarc.fo.clone() + &"\", \"".to_string() + &req.dns.mta_sts.version.clone() + &"\", \"".to_string() + &req.dns.mta_sts.sn.clone() + &"\", \"".to_string() + &req.dns.spf.version.clone() + &"\", \"".to_string();
	...
	requete2 = requete2 + &"\", \"".to_string();
     ...
     requete2 = requete2 + &"\", \"".to_string(); + &req.dns.spf.ip.clone() + &"\", \"".to_string();
	for i in &req.dns.spf.include {
    		requete2=requete2 + &i;
        }
     requete2 = requete2  + &"\", \"".to_string() + &req.dns.spf.all.clone()  + &"\", \"".to_string() + &req.dns.tls_rpt.v.clone() + &"\", \"".to_string() + &req.dns.tls_rpt.rua.clone() + &"\",".to_string() + &req.dns.bimi.note.to_string() + &", ".to_string() + &req.dns.certificate.note.to_string() + &", ".to_string() + &req.dns.dane.note.to_string()  + &", ".to_string() + &req.dns.dmarc.note.to_string()  + &", ".to_string() + &req.dns.mta_sts.note.to_string() + &", ".to_string() + &req.dns.spf.note.to_string() + &", ".to_string() + &req.dns.tls_rpt.note.to_string() + &") ".to_string();
...
requete2=requete2 +&"\", \"".to_string() + &req.dns.spf.all.clone() + &"\", \"".to_string() + &req.dns.tls.v.clone() + &"\", \"".to_string() + &req.dns.tls.rua.clone() + &"\", ".to_string() + &req.dns.bimi.note.to_string() + &", ".to_string() + &req.dns.certificate.note.to_string() + &", ".to_string() + &req.dns.dane.note.to_string() +  &", ".to_string() + &req.dns.dmarc.note.to_string() + &", ".to_string() + &req.dns.mta.note.to_string() + &", ".to_string() + &req.dns.spf.note.to_string() + &", ".to_string() + &req.dns.tls.note.to_string() + &", ".to_string() + &req.dns.note.to_string()  + &"); ".to_string();
  */  
    let mut pool = mysql::MySqlConnectOptions::new()
    	.host("mysql.default")
    	.username("ice_crawler_user")
