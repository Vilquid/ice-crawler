...
async fn recupdomain(req: Json<Domaine>) -> HttpResponse {
	...
	/*let mut re = Re { resultat: vec![DATAResult {tls: Retour {certificat: String::new(), liste: Vec::new(), cyfaible: String::new(), starttls: String::new(), versions: ["fail".to_string(),"fail".to_string(),"fail".to_string(),"fail".to_string()], note: 0 as u16, ip: String::new() }, dns: DNSRecord { domain: String::new(), note: 0 as f32, dmarc: DMARCRecord { v: String::new(), p: String::new(), sp: String::new(), pct: String::new(), ruf: String::new(), rua: String::new(), ri: String::new(), rf: String::new(), aspf: String::new(), adkim: String::new(), fo: String::new(), note: 0 as f32 } , spf: SPFRecord { version: String::new(), mechanisms: Vec::new(), qualifier: String::new(), ip: Vec::new(), include: Vec::new(), all: String::new(), note: 0 as f32 } , dane : DANERecord { forme_certificat: String::new(), signature_certificat: false, signature_cle_publique: false, presence_hash: false, hash: String::new(), note: 0 as f32 } , bimi: BIMIRecord { version: String::new(), url_expediteur: String::new(), url_politique: String::new(), url_reputation: String::new(), hash: String::new(), s: String::new(), note: 0 as f32 } , mta: MTARecord { version: String::new(), sn: String::new(), note: 0 as f32 } , tls: TLSRecord { v: String::new(), rua: String::new(), note: 0 as f32 } , certificate : CertificateRecord { domain: String::new(), signature_algorithm_server: String::new(), issuer_server: IssuerDetails { city: String::new(), state: String::new(), locality: String::new(), organization: String::new(), common_name: String::new() } , validity_server: ValidityDetails { not_before: String::new(), not_after: String::new(), is_valid: false } , subject_server: SubjectDetails { city: String::new(), state: String::new(), locality: String::new(), organization: String::new(), common_name: String::new() } , extensions_server: ExtensionsDetails { subject_alternative_names: Vec::new() } , signature_algorithm_intermediate: String::new(), issuer_intermediate: IssuerDetails { city: String::new(), state: String::new(), locality: String::new(), organization: String::new(), common_name: String::new() } , validity_intermediate: ValidityDetails { not_before: String::new(), not_after: String::new(), is_valid: false } , subject_intermediate: SubjectDetails { city: String::new(), state: String::new(), locality: String::new(), organization: String::new(), common_name: String::new() } , extensions_intermediate: ExtensionsDetails { subject_alternative_names: Vec::new() } , note: 0 as f32 } } }] };*/
		...
		while let Some(row) = result.try_next().await.expect("ah") {
		    ...
		    let donnee = DATAResult {tls: Retour {certificat: row.try_get("tls.certificat").expect("recuperation ratée"), liste: vec![row.try_get("tls.liste").expect("recuperation ratée")], cyfaible: row.try_get("tls.cyfaible").expect("recuperation ratée"), starttls: row.try_get("tls.starttls").expect("recuperation ratée"), versions: ["fail".to_string(),"fail".to_string(),"fail".to_string(),"fail".to_string()], note: row.try_get("tls.note").expect("recuperation ratée") as u16, ip: row.try_get("ip").expect("recuperation ratée") }, dns: DNSRecord { domain: row.try_get("domain").expect("recuperation ratée"), note: row.try_get("note").expect("recuperation ratée"), dmarc: DMARCRecord { v: row.try_get("dmarc.v").expect("recuperation ratée"), p: row.try_get("dmarc.p").expect("recuperation ratée"), sp: row.try_get("dmarc.sp").expect("recuperation ratée"), pct: row.try_get("dmarc.pct").expect("recuperation ratée"), ruf: row.try_get("dmarc.ruf").expect("recuperation ratée"), rua: row.try_get("dmarc.rua").expect("recuperation ratée"), ri: row.try_get("dmarc.ri").expect("recuperation ratée"), rf: row.try_get("dmarc.rf").expect("recuperation ratée"), aspf: row.try_get("dmarc.aspf").expect("recuperation ratée"), adkim: row.try_get("dmarc.adkim").expect("recuperation ratée"), fo: row.try_get("dmarc.fo").expect("recuperation ratée"), note: row.try_get("dmarc.note").expect("recuperation ratée") } , spf: SPFRecord { version: row.try_get("spf.version").expect("recuperation ratée"), mechanisms: vec![row.try_get("spf.mechanisms").expect("recuperation ratée")], qualifier: row.try_get("spf.qualifer").expect("recuperation ratée"), ip: vec![row.try_get("spf.ip").expect("recuperation ratée")], include: vec![row.try_get("spf.include").expect("recuperation ratée")], all: row.try_get("spf.all").expect("recuperation ratée"), note: row.try_get("spf.note").expect("recuperation ratée") } , dane : DANERecord { forme_certificat: row.try_get("dane.forme_certificat").expect("recuperation ratée"), signature_certificat: row.try_get("dane.signature_certificat").expect("recuperation ratée"), signature_cle_publique: row.try_get("dane.signature_cle_publique").expect("recuperation ratée"), presence_hash: row.try_get("dane.presence_hash").expect("recuperation ratée"), hash: row.try_get("dane.hash").expect("recuperation ratée"), note: row.try_get("dane.note").expect("recuperation ratée") } , bimi: BIMIRecord { version: row.try_get("bimi.version").expect("recuperation ratée"), url_expediteur: row.try_get("bimi.url_expediteur").expect("recuperation ratée"), url_politique: row.try_get("bimi.url_politique").expect("recuperation ratée"), url_reputation: row.try_get("bimi.url_reputation").expect("recuperation ratée"), hash: row.try_get("bimi.hash").expect("recuperation ratée"), s: row.try_get("bimi.s").expect("recuperation ratée"), note: row.try_get("bimi.note").expect("recuperation ratée") } , mta: MTARecord { version: row.try_get("mta_sts.version").expect("recuperation ratée"), sn: row.try_get("mta_sts.sn").expect("recuperation ratée"), note: row.try_get("mta_sts.note").expect("recuperation ratée") } , tls: TLSRecord { v: row.try_get("tls_rpt.v").expect("recuperation ratée"), rua: row.try_get("tls_rpt.rua").expect("recuperation ratée"), note: row.try_get("tls_rpt.note").expect("recuperation ratée") } , certificate : CertificateRecord { domain: row.try_get("domain").expect("recuperation ratée"), signature_algorithm_server: row.try_get("signature_algorithm_server").expect("recuperation ratée"), issuer_server: IssuerDetails { city: row.try_get("IssuerDetails.city").expect("recuperation ratée"), state: row.try_get("IssuerDetails.state").expect("recuperation ratée"), locality: row.try_get("IssuerDetails.locality").expect("recuperation ratée"), organization: row.try_get("IssuerDetails.organization").expect("recuperation ratée"), common_name: row.try_get("IssuerDetails.common_name").expect("recuperation ratée") } , validity_server: ValidityDetails { not_before: row.try_get("ValidityDetails.not_before").expect("recuperation ratée"), not_after: row.try_get("ValidityDetails.not_after").expect("recuperation ratée"), is_valid: row.try_get("ValidityDetails.is_valid").expect("recuperation ratée") } , subject_server: SubjectDetails { city: row.try_get("SubjectDetails.city").expect("recuperation ratée"), state: row.try_get("SubjectDetails.state").expect("recuperation ratée"), locality: row.try_get("SubjectDetails.locality").expect("recuperation ratée"), organization: row.try_get("SubjectDetails.organization").expect("recuperation ratée"), common_name: row.try_get("SubjectDetails.common_name").expect("recuperation ratée") } , extensions_server: ExtensionsDetails { subject_alternative_names: vec![row.try_get("ExtensionsDetails.subject_alternative_names").expect("recuperation ratée")] } , signature_algorithm_intermediate: row.try_get("signature_algorithm_intermediate").expect("recuperation ratée"), issuer_intermediate: IssuerDetails { city: row.try_get("issuer_intermediate.city").expect("recuperation ratée"), state: row.try_get("issuer_intermediate.state").expect("recuperation ratée"), locality: row.try_get("issuer_intermediate.locality").expect("recuperation ratée"), organization: row.try_get("issuer_intermediate.organization").expect("recuperation ratée"), common_name: row.try_get("issuer_intermediate.common_name").expect("recuperation ratée") } , validity_intermediate: ValidityDetails { not_before: row.try_get("validity_intermediate.not_before").expect("recuperation ratée"), not_after: row.try_get("validity_intermediate.not_after").expect("recuperation ratée"), is_valid: row.try_get("validity_intermediate.is_valid").expect("recuperation ratée") } , subject_intermediate: SubjectDetails { city: row.try_get("subject_intermediate.city").expect("recuperation ratée"), state: row.try_get("subject_intermediate.state").expect("recuperation ratée"), locality: row.try_get("subject_intermediate.locality").expect("recuperation ratée"), organization: row.try_get("subject_intermediate.organization").expect("recuperation ratée"), common_name: row.try_get("subject_intermediate.common_name").expect("recuperation ratée") } , extensions_intermediate: ExtensionsDetails { subject_alternative_names: vec![row.try_get("extensions_intermediate.subject_alternative_names").expect("recuperation ratée")] } , note: row.try_get("certificate.note").expect("recuperation ratée") }  } };
